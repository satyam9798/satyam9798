...
Experienced in working with **Git**, **JIRA**, **Confluence**, and practicing **Test-Driven Development (TDD)**, along with building CI/CD pipelines and following **Agile** methodologies.

Proficient in cloud and container technologies including **AWS**, **Docker**, and **Kubernetes**.

Strong knowledge of both frontend and backend technologies, focused on delivering robust full-stack solutions.
